...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out_2, cache_2 = affine_forward(out_relu, W2, b2)
        ...
        d_out_relu, dW2, db2 = affine_backward(dsoftmax, cache_2)
        d_out_1 = relu_backward(d_out_relu, cache_relu)
        dx, dW1, db1 = affine_backward(d_out_1, cache_1)
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        #insert last layer dim
        layer_dims.insert(len(layer_dims), num_classes)
    ...
    def loss(self, X, y=None):
        ...
        #print("Scores shape: ", affine_out[idx][0].shape)
        ...
        for i in range(self.num_layers, 0, -1):
            ...
            w_name = 'W' + str(idx)
            b_name = 'b' + str(idx)
            dx, dw, db = affine_backward(dout, affine_out[idx][1])
